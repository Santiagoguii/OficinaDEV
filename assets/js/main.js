...
import { anuncios } from "./projetos.js";

const navigation = document.querySelector("#navigation");
const backToTopButton = document.querySelector("#backToTopButton");
const toggle = document.querySelector("#sw-checkbox");
const anunciosSection = document.querySelector("#anuncios .wrapper");
...
function onScroll() {
  ...
  activateMenuAtCurrentSection(anuncios);
  activateMenuAtCurrentSection(anunciose);
